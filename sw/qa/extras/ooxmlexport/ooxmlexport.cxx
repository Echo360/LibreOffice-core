...
DECLARE_OOXMLEXPORT_TEST(testTextBoxGradientAngle, "fdo65295.docx")
{
    ...
    // Angle of frame#2 is  90 degrees, but 'aGradient.Angle' holds value in 1/10 of a degree
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16( 90 * 10), aGradient2.Angle);

    // Angle of frame#3 is  45 degrees, but 'aGradient.Angle' holds value in 1/10 of a degree
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16( 45 * 10), aGradient3.Angle);

    // Angle of frame#4 is   0 degrees, but 'aGradient.Angle' holds value in 1/10 of a degree
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16(  0 * 10), aGradient4.Angle);

    // Angle of frame#5 is 180 degrees, but 'aGradient.Angle' holds value in 1/10 of a degree
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16(180 * 10), aGradient5.Angle);
    ...
    // Angle of frame#7 is 270 degrees, but 'aGradient.Angle' holds value in 1/10 of a degree
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16(270 * 10), aGradient7.Angle);

    // Angle of frame#8 is 225 degrees, but 'aGradient.Angle' holds value in 1/10 of a degree
    ...
    CPPUNIT_ASSERT_EQUAL(sal_Int16(225 * 10), aGradient8.Angle);
}
